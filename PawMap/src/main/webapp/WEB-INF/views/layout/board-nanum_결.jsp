...
prefix="spring" %> <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt"
prefix="fmt"%>
            ...
            <div class="col-md-6 col-lg-4 col-xl-4">
              <div class="blog-box">
                <div class="blog-img">
                  <img
                    class="img-fluid"
                    src="images/gyul_pet_toy_001.jpg"
                    alt=""
                  />
                </div>
                <div class="blog-content">
                  <div class="title-blog">
                    <h3>
                      <a
                        href="getBoardDetail?boardSeq=${nanumBoardList.boardSeq }&boardType=${nanumBoardList.boardType }"
                        >제목 : ${nanumBoardList.title}</a
                      >
                    </h3>
