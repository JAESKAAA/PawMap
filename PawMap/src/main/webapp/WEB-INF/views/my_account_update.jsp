          ...
          <div class="input-form col-md-12 mx-auto u_join-box">
            <form class="validation-form" method="post" action="/pawmap/mypage/updateUser" novalidate
              ...
              <div class="mb-3">
                ...
                <input type="text" class="uptxtbox" id="customer-id" name="userId" value="${principal.user.userId }"
                  disabled />
              </div>
              <div class="mb-3">
                <label for="password">비밀번호</label>
                <input type="password" class="uptxtbox" id="password" name="userPassword" placeholder="패스워드입력"
                  maxlength="30" required />
                <div class="invalid-feedback">비밀번호를 입력해주세요.</div>
              </div>
              <div class="mb-3">
                <label for="password">비밀번호 확인</label>
                <input type="password" class="uptxtbox" id="password" placeholder="비밀번호 재입력" maxlength="12" required />
                <div class="invalid-feedback">비밀번호를 입력해주세요.</div>
              </div>
              <div class="mb-3">
                <label for="nickname" style="width: 100%">닉네임</label>
                <input type="text" style="display: inline-block; width: 70%" name="userNickname" class="uptxtbox"
                  id="user_nickname" value="${user.userNickname }" />
              ...
              <div class="mb-3">
                ...
                <input type="phone" class="uptxtbox" id="phone" name="userTelNum" placeholder="연락처입력"
                  value="${user.userTelNum }" required />
              </div>
              <div class="mb-3">
                <label for="email" style="width: 100%">이메일</label>
                <input type="email" style="display: inline-block; width: 70%" class="uptxtbox" name="userEmail"
                  id="user_email" value="${user.userEmail }" required />
              ...
              <div class="mb-3">
                ...
                <input type="text" class="uptxtbox" id="address" name="address" value="${user.address }" required />
              </div>
              <c:choose>
              ...
              <hr class="mb-4" />
              <div class="mb-4">
                <button class="btn" id="upbtn" type="submit" style="width: 30%;  position:  relative; float: left; background: rgb(239, 199, 120,1) !important;
                  border: solid rgb(239, 199, 120,1) !important;  margin: 5px;">수정
                </button>
                <button class="btn" id="upbtn" onclick="history.go(-1);return false;" style="width: 30%; position:  relative; float: left; background: rgb(239, 199, 120,1) !important;
              border: solid rgb(239, 199, 120,1) !important;  margin: 5px;">취소
                </button>
              </div>
              <div class="mb-4">
                <button class="btn" id="upbtn" style="text-align: center; background: rgb(239, 199, 120,1) !important;
              border: solid rgb(239, 199, 120,1) !important; margin: 5px;" onclick="deleteUserCheck()">회원탈퇴
                </button>
          </div>
        </form>
