...
=================================================-->
        <div class="petAddBox">
            ...
            <!-- Start 반려동물 추가 영역 -->
            <form class="form" action="/pawmap/mypage/insertPetInfo" method="post" id="inserPetInfo"
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="text-center">
                                ...
                                <input type="file" name="uploadPetFile"
                        ...
                        <div class="col-m-12">
                            <div class="tab-content">
                                <div class="tab-pane active">
                                    <div>
                                        <input class="petaddinput" type="hidden" name="userId" value="${user.userId}">
                                    </div>
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <h2 style="display: none;">${user.userId}</h2>
                                        ...
                                        <div class="col-m-12">
                                            ...
                                            <div>
                                                ...
                                                <input type="radio" name="petType" id="r2" value="고양이"><label
                                                    for="r2">고양이</label>
                                                <input type="radio" name="petType" id="r4" value="새"><label
                                                    for="r3">새</label>
                                                <input type="radio" name="petType" id="r5" value="곤충류"><label
                                                    for="r4">곤충류</label>
                                                <input type="radio" name="petType" id="r6" value="설치류"><label
                                                    for="r5">설치류</label>
                                                <input type="radio" name="petType" id="r7" value="파충류"><label
                                                    for="r6">파충류</label>
                                    ...
                                    <br>
                                    <div class="form-group optioncolor">
                                        <div class="col-m-12">
                                            ...
                                            <div>
                                                <input type="input" id="writeType" style="display: none; "
                                                    class="petaddinput" name="petTypeDetail" placeholder="직접입력">
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        <div class="col-xs-6">
                                            ...
                                            <textarea type="input" class="petsymptominput" name="symptom" id="kind"
                                                placeholder="증상을 적어주세요"></textarea>
                                        </div>
                                    </div>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $("input:radio[type=radio]").click(function () {
                        ...
                        } else if ($("input[type=radio]:checked").val() == "직접입력") {
                            //직접입력 박스 활성화
                            $("select[id=catTypeDetail]").hide();
                            $("select[id=dogTypeDetail]").hide();
                            $("select[id=birdTypeDetail]").hide();
