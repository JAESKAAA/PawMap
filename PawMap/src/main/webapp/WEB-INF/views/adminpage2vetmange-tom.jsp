...
<head>
  ...
  <!-- Site Metas -->
  <title>adminpage2vetmanage</title>
...
<body style="background-color: #f8f9fa">
  ...
  <header class="main-header">
    <!-- Start Navigation -->
    <!--하기 navbar navbar-expand-lg를 md로 교체-->
    <nav class="navbar navbar-expand-md navbar-light bg-light navbar-default bootsnav">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html"><img src="images/pawmaplogo.png" class="logo" alt="" width="216"
              height="118"></a>
        </div>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="associatedvetlist" style="margin-top: 40px;">
          <form id="thismustcalldbfrompawmapuser" action="must put method" name="POST" method="GET"><!-- tom is working on this section on nov 26th 5:20pm-->
          <table class="table-list" style="margin-left: 3%; margin-right: 3%; text-align: center; border: 1px solid black">
            <colgroup>
              ...
              <col style="width:10%;">
              <col style="width:7%;">
              <!--consider binding the custom-tom.css file. this comment was left on november 25th 20:34pm by thomas lee-->
            </colgroup>
            ...
            <tbody><!-- 5:17 pm on nov 26th tom is working on this section... -->
              <c:forEach var="freeBoard" items="${freeBoardList }">
              <tr>
                <td>1</td>
                <td>pawhospital1</td>
                <td>paw4567890paw45@gmail.com</td>
                <td>발바닥_동물병원90123456789</td>
                <td>070-9999-1234</td>
                <td>서울시 강남구 반포동 눈누난나</td>
                <td>74541845612354</td>
                <td>일반</td>
                <td>2021-11-24 16:54:38</td>
                <td><button style="margin-left: 30px; border-style: none;" type="button"
                    onclick="location.href='adminpage3vetmodify-tom.html'">관리하기</button></td>
              </tr>
              <tr>
                <td>2</td>
                <td>bowwhospital2</td>
                <td>bow4567890paw45@gmail.com</td>
                <td>손바닥_동물병원90123456789</td>
                <td>100-8888-1234</td>
                <td>서울시 서초구 반포동 눈누난나</td>
                <td>99991845612354</td>
                <td>병원</td>
        ...
        <!--제휴 병원 관리 테이블 리스트 끝-->
        </form> <!-- this is closing form tag for any data that was saved on DB would show up--> 
        <!--페이지 네비게이션 시작-->
        <div class="row mt-2">
            ...
            <div class="footer-link-contact">
              ...
              <div class="footer-top-box">
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      <a href="#" class="inner-box"><i class="fab fa-twitter inner-box-icon" aria-hidden="true"></i></a>
                    </p>
                  </li>
                  <li>
                    <p>
