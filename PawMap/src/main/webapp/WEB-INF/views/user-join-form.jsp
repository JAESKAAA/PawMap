            ...
            <table class="u_join-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td><input required="required" type="text" name="userPassword" id="userPassword"
                      placeholder="8~20자리 영문,숫자,특수문자" class="input w130"></td>
                </tr>
                <tr>
                  <th> 이름 <span>*</span></th>
                  <td>
                    <div class="u_input-button">
                      <input required="required" type="text" maxlength="320" name="userName" id="user_name"
                        class="input w220">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="u_input-button">
                      <input required="required" type="email" maxlength="320" name="userEmail" id="user_email"
                        class="input w220" placeholder="ex) abc@mail.com">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <div class="u_input-button">
                      <input required="required" name="userTelNum" id="user_tel_num" type="tel" maxlength="320"
                        class="input w220" placeholder="'-' 를 빼고 입력해 주세요">
                    </div>
                  </td>
                </tr>
                <tr>
                    ...
                    <div class="u_input-box-address">
                      <div class="address_input_1_wrap">
                        <div class="address_input_1_box">
                          <input class="address_input_1 input w40" name="postNum" readonly="readonly" maxlength="5"
                            placeholder="우편번호">
                      ...
                      <div class="address_input_2_wrap">
                        <div class="address_input_2_box">
                          <input class="address_input_2" name="address" maxlength="80" readonly="readonly"
                            placeholder="기본주소">
                        </div>
                      </div>
                      <div class="address_input_3_wrap">
                        <div class="address_input_3_box">
                          <input class="address_input_3" name="addressDetail" maxlength="80" readonly="readonly"
                            placeholder="상세주소">
                        </div>
                      </div>
                    </div>
                ...
                <tr>
                  <th> 닉네임 <span>*</span></th>
                  <td>
                    <div class="u_input-button"><input name="userNickname" id="user_nickname" placeholder="닉네임"
                        type="text" class="input w220">
