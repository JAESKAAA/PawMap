                    ...
                    <div class="blog-box">
                        ...
                        <div class="blog-content">
                            <div class="title-blog">
                                <h3><a href="getFreeBoard?boardSeq=${nanumBoardList.boardSeq }&boardType=${nanumBoardList.boardType }&pageNum=${pageMaker.cri.pageNum}&amount=${pageMaker.cri.amount}">제목 : ${nanumBoardList.title}</a></h3>
                                <p>내용 : ${nanumBoardList.content}</p>
                            </div>
                        </div>
                        <div class="blog-content">
                            <div class="title-blog pt-1">
                                <h3>닉네임 : ${nanumBoardList.userVO.userNickname } </h3>
                            </div>
                        </div>
                    </div>
                </div>
