...
public class BoardServiceImpl implements BoardService {
	...
	@Override /*below method is for admin management.. this method would call the data from dbms on nov 26th 18:40pm */
	public AdminManageBoardVO getAdminBoardList(int userSeq) {
		
		System.out.println("BoardServiceImpl 의 userSeq ======"+userSeq);
		
		return boardMapper.getAdminBoardList(userSeq); /* the boardMapper.getFreeboard needs to be replace...*/
	}
