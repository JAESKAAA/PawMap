...
<body>
    ...
    <!-- 게시판 폼 시작 -->
    <form class="form-horizontal board-form" role="form" action="/pawmap/board/insertBoard" method="post" enctype="multipart/form-data">
        <div class="container">
            <div class="card row">
                <div class="option-select ml-5">
                    <select class="form-control" name="boardType" value="">
                ...
                <div class="form-group ml-5 ">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control input-nickname" id="userId" name="userId" value="" placeholder="로그인한 회원 닉네임(수정불가) ">
                    </div>
                </div>
                <div class="form-group ml-5 ">
                ...
                <div class="form-group ml-5">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control content" rows="4" name="content" value=""></textarea>
                    </div>
                </div>
                                ...
                                <div class="control-group" id="fields">  
                                    <div class="controls">  
                                        <div class="entry input-group upload-input-group">  
                                            <input class="form-control btn-file-upload" type="file">  
                                        </div>  
                                    </div>  
                                </div>  
                            </div>  
